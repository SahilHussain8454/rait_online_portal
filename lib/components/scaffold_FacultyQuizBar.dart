...
class FacultyQuizAppBar extends StatefulWidget {
  FacultyQuizAppBar({@required this.label, @required this.containerContent});
  final String label;
  final Container containerContent;

  @override
  _FacultyQuizAppBarState createState() => _FacultyQuizAppBarState();
}

class _FacultyQuizAppBarState extends State<FacultyQuizAppBar> {
